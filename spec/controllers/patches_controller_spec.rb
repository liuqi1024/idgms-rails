  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved patch as @patch" do
        ...
        post :create, {:patch => { "code" => "invalid value" }}, valid_session
        assigns(:patch).should be_a_new(Patch)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested patch" do
        ...
        Patch.any_instance.should_receive(:update_attributes).with({ "code" => "MyString" })
        put :update, {:id => patch.to_param, :patch => { "code" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the patch as @patch" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Patch.any_instance.stub(:save).and_return(false)
        put :update, {:id => patch.to_param, :patch => { "code" => "invalid value" }}, valid_session
        assigns(:patch).should eq(patch)
      end
